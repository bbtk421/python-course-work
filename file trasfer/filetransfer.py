...
#source = self.get(textBox1) #"/C:/Users/bbtk4/Documents/GitHub/python-course-work/file transfer/A/"
#dest = self.get(textBox2) #"/C:/Users/bbtk4/Documents/GitHub/python-course-work/file transfer/B/"
...
class ParentWindow(Frame): #brought all this over from the earlier assignment
      ...
      def check_files(self): #should run when clicking the Check for files... button
            ...
            for i in files:
                  ...
                  modifyDate = datetime.datetime.fromtimestamp(os.path.getmtime(absolutePath))
